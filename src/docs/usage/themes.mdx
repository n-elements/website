...
<a href="https://app.native-elements.dev/" data-hide-icon rel="noopener" target="_blank"><img src="/img/tb.png" /></a>

<Spacer height="40px" />

:::note
This is currently the best and recommended way to change properties
:::
