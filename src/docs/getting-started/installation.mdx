...
@import '@native-elements/core/dist/native-elements.css';
```
...
You need now to tell PostCSS to use the plugins required by Native Elements, here the full configuration file with the settings:
