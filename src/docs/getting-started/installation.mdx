...
To use the library source and unleash the full potentiality you have to use a package manager like <a href="https://www.npmjs.com/" target="_blank" rel="noopener noreferrer">npm</a>, <a href="https://yarnpkg.com/" target="_blank" rel="noopener noreferrer">yarn</a>, or <a href="https://pnpm.js.org/" target="_blank" rel="noopener noreferrer">pnpm</a> , and then install all the required packages inside your project:

```sh
yarn add @native-elements/core camelcase postcss-easy-import postcss-preset-env postcss-mixins cssnano cssnano-preset-advanced
```

You need now to tell PostCSS to use the plugins required by Native Elements, here the configuration file with the settings:
...
:::note
We don't encourage using this approach if you not know very well what you are doing.
:::
